...
eonik gets you **finished, on-brand ads without the busywork.** Use this skill whenever the assistant is connected to **this user’s** eonik account. Auth is the host connection (API key). The cut itself is made on Mac. **You approve every cut. Nothing here moves budget.**
